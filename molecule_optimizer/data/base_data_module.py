...
from molecule_optimizer.data.util import BaseDataset
...
class BaseDataModule(pl.LightningDataModule):
    ...
    def config(self):
        """Return important settings of the dataset, which will be passed to
        instantiate models."""
        return {
    ...
    def prepare_data(self, *args, **kwargs) -> None:
        ...
        be done only from a single GPU in distributed settings
        (so don't set state `self.x = y`).
        """
